...
public class ArmGeometry {
    ...
    public static class ArmPositions {
         ...
         * allowable extension zone (48" horizontally beyond the frame), and above the ground. The strategy is to
        ...
        public boolean clipToValidInPlay() {
            ...
            if (clippedLocation) {
                ArmPositions newPositions = getArmPositionsFromLocation(location.x, location.y);
    ...
    public static final double FLOOR_EXTENSION_SAFETY_BUFFER = 3.0;
    ...
    public static ArmPositions getArmPositionsFromLocation(double x, double y) {
        ...
        return new ArmPositions(getPivotPositionFromAngle(pivotAngle), getExtensionPositionFromArmLength(armLength));
    }
}
