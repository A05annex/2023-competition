...
public class ConePlaceCommandGroup extends SequentialCommandGroup {
    ...
    public ConePlaceCommandGroup(XboxController altXbox, A05Constants.DriverSettings driver) {
        super(new ConePositionCommand(altXbox, driver),
                new ConditionalCommand(new AbsoluteSmartTranslateCommand(0.0, -0.50, 1.0, 7000.0).withTimeout(1.25), new AbsoluteSmartTranslateCommand(0.0, 0.57, 1.0, 7000.0).withTimeout(1.25), ConePlaceCommandGroup::getDirection),
                new AbsoluteTranslateCommand(0.7, 0.0, 0.1).withTimeout(1.75),
